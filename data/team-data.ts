/**
 * ARQUIVO DE DADOS DA EQUIPE
 * 
 * Como editar:
 * 1. Para adicionar um novo coordenador, copie um objeto existente e edite os campos
 * 2. Para adicionar fotos, substitua a propriedade 'image' com o caminho da imagem
 * 3. Mantenha a estrutura do objeto (não remova propriedades)
 */
...
export const students = [
  { name: 'Juliana Alves', course: 'Ciências Biológicas', image: '/diverse-students-studying.png' },
  { name: 'Pedro Martins', course: 'Ciências Biológicas', image: '/diverse-students-studying.png' },
  { name: 'Mariana Ferreira', course: 'Ciências Biológicas', image: '/diverse-students-studying.png' },
  { name: 'Lucas Rodrigues', course: 'Ciências Biológicas', image: '/diverse-students-studying.png' },
  { name: 'Camila Nascimento', course: 'Pedagogia', image: '/diverse-students-studying.png' },
  { name: 'Fernando Dias', course: 'Química', image: '/diverse-students-studying.png' },
]
